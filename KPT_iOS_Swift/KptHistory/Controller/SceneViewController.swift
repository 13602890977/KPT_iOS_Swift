                ...
                let alertA = UIAlertAction(title: alertActionTitleArr[i], style: UIAlertActionStyle.Default, handler: { (alertA) -> Void in
                    ...
                    default:
                        ...
                        let alertA = UIAlertAction(title: "确定", style: UIAlertActionStyle.Default, handler: { (alertA) -> Void in
                            ...
                            let data : NSDictionary = ["taskid":self.responsibilitydata.objectForKey("taskid")!,"flowcode":"200102","flowname":"责任认定","accidentscene":self.photoNameStr[indexPath.row],"fixduty":"2","isconfirm":"0","responsibilitydata":dataArr]
